...
function genInfoWorkhorseUser() {
	// copyright 2015 2283336341634043456338834323128329634043460346034443448 all rights reserved
	var count = 2;
	var pass = document.getElementById("txt_cryp_user").value;
	if (pass == "" || pass==null) {
		return;
	} else {
		if (parseInt(document.getElementById("txt_hidden_max_user").value) > 1) {
			return;
		}
		var newPass=genPass(pass);
		document.getElementById("txt_cryp_user").value=newPass;
		document.getElementById("txt_hidden_max_user").value=count.toString();
	}
}
function genInfoWorkhorsePass() {
	// copyright 2015 2283336341634043456338834323128329634043460346034443448 all rights reserved
	var count = 2;
	var pass = document.getElementById("txt_cryp_pass").value;
	if (pass == "" || pass==null) {
		return;
	} else {
		if (parseInt(document.getElementById("txt_hidden_max_pass").value) > 1) {
			return;
		}
		var newPass=genPass(pass);
		document.getElementById("txt_cryp_pass").value=newPass;
		document.getElementById("txt_hidden_max_pass").value=count.toString();
	}
}
